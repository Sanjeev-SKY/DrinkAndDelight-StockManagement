...
public class RawMaterialController {
	...
	@PostMapping
	public ResponseEntity<RawMaterialModel> addProcessDate(@RequestBody RawMaterialModel model) throws RawMaterialException{
	...
	public ResponseEntity<RawMaterialOrderModel> findById(@PathVariable("orderId") long orderId) {
		...
		RawMaterialOrderModel model = rmoService.findById(orderId);
	...
	@PutMapping
	public ResponseEntity<RawMaterialModel> updateRawMaterialDetails(@RequestBody RawMaterialModel model) throws RawMaterialException {
